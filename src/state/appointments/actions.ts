...
export const clearCurrentAppointmentAction = (): ClearCurrentAppointment => ({
...
export const reserveStartAction = (
...
export const reserveSuccessAction = (payload: Reservation): ReserveSuccess => ({
  type: ACTION_STRINGS.RESERVE_SUCCESS,
  payload,
});

export const reserveErrorAction = (payload: any): ReserveError => ({
  type: ACTION_STRINGS.RESERVE_ERROR,
  payload,
});

export const clearCurrentReservationAction = (): ClearCurrentReservation => ({
  type: ACTION_STRINGS.CLEAR_CURRENT_RESERVATION,
  payload: null,
});

export const confirmStartAction = (
...
export const confirmSuccessAction = (payload: Appointment): ConfirmSuccess => ({
  type: ACTION_STRINGS.CONFIRM_SUCCESS,
  payload,
});

export const confirmErrorAction = (payload: any): ConfirmError => ({
