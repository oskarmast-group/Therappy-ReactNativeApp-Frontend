...
import { FunctionModes, UpdateDocumentUploadProps, useDocumentUpload } from '../useDocumentUpload';
...
const Document: React.FC<{ document: Documentation }> = ({ document }) => {
  ...
  const { dispatcher: requiredDocumentationDispatcher } = useRequiredDocumentation();
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.menuContainer} onPress={() => setShowOptions(!showOptions)}>
        <DotMenuIcon />
      </TouchableOpacity>
      <TouchableOpacity style={styles.fileContainer} onPress={() => openBrowserForDownload(docURL)}>
        <FileIcon />
      </TouchableOpacity>
