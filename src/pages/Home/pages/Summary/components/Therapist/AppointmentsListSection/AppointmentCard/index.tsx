      ...
      <Link to={`/appointment/${app.roomId}`}>
        <View style={styles.linkChildrenContainer}>
          ...
          <View style={styles.informationContainer}>
            ...
            <BaseText>{getDisplayDate(app.date, 'EEEE - MMMM d, yyyy')}</BaseText>
          </View>
        </View>
      </Link>
      <Button
        ...
        disabled={appointments.fetching.isFetching && appointments.fetching.config?.key === 'accept'}
      >
        {appointments.fetching.isFetching && appointments.fetching.config?.key === 'accept' ? (
