...
function App(): JSX.Element {
  ...
  useEffect(() => {
    if (height) {
      ...
      const spaceForMessages = height - decorationHeight - headerHeight - inputBoxHeight;
  ...
  return (
    <Routes>
      ...
      <Route path="/videollamada/*" element={<PrivateRoute component={Videocall} />} />
      ...
      <Route path="/appointment/*" element={<PrivateRoute component={Appointment} />} />
    </Routes>
  );
}
